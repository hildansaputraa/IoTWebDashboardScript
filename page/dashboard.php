                    ...
                    <?php for ($i = 1; $i <= 4; $i++) { ?>
                      <div class="col-md-3">
                        <div class="card card-<?php echo ['primary', 'success', 'warning', 'danger'][$i - 1]; ?>">
                          ...
                          <div class="card-body">
                            <p>Tegangan: <span id="node<?php echo $i; ?>-tegangan"><?php echo $fallback[$i]['tegangan'] ?? '-' ?></span> V</p>
                            <p>Arus: <span id="node<?php echo $i; ?>-arus"><?php echo $fallback[$i]['arus'] ?? '-' ?></span> mA</p>
                            <p>Water Level A: <span id="node<?php echo $i; ?>-waterlvA"><?php echo $fallback[$i]['waterlvA'] ?? '-' ?></span> cm</p>
                            <p>Water Level B: <span id="node<?php echo $i; ?>-waterlvB"><?php echo $fallback[$i]['waterlvB'] ?? '-' ?></span> cm</p>
                            <p>Flow Rate: <span id="node<?php echo $i; ?>-flowrate"><?php echo $fallback[$i]['flowrate'] ?? '-' ?></span> L/min</p>
                            <p>Total Water: <span id="node<?php echo $i; ?>-totalwater"><?php echo $fallback[$i]['totalwater'] ?? '-' ?></span> L</p>
                            <p>RSSI: <span id="node<?php echo $i; ?>-rssi"><?php echo $fallback[$i]['rssi'] ?? '-' ?></span> dBm</p>
                          </div>
                        </div>
                      </div>
                    <?php } ?>
